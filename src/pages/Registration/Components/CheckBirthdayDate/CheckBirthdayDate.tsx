    ...
    dispatch(
      sendResponse({
        ...
        dateOfBirth: fullDate(
          day,
          year,
          months.findIndex((it) => it === month) + 1
        ),
        nav: nav,
      })
    );
    ...
    <div className="ckeck_birthday_container">
      {!isValid && (
        <div className="birthday_text">
          {t("You need to enter the date you were born on")}
        </div>
      )}
      <div className="birthday_text text">
        {t(
